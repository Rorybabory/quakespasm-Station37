...
#define SU_WATERS2		(1<<23) // 1 byte, this is .ammo_water & 0xFF00 (second byte)
#define SU_EXTEND2		(1<<24) // another byte to follow
#define SU_WEAPONFRAME2	(1<<25) // 1 byte, this is .weaponframe & 0xFF00 (second byte)
#define SU_WEAPONALPHA	(1<<26) // 1 byte, this is alpha for weaponmodel, uses ENTALPHA_ENCODE, not sent if ENTALPHA_DEFAULT
#define SU_UNUSED26		(1<<27)
#define SU_UNUSED27		(1<<28)
#define SU_UNUSED28		(1<<29)
#define SU_UNUSED29		(1<<30)
#define SU_UNUSED30		(1<<31)
#define SU_EXTEND3		(1<<32) // another byte to follow, future expansion
//johnfitz
