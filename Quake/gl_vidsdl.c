...
QS_PFNGLGENFRAMEBUFFERSPROC GL_GenFramebuffersFunc = NULL; //rorybabory
QS_PFNGLBINDFRAMEBUFFERPROC GL_BindFramebufferFunc = NULL; //rorybabory
QS_PFNGLFRAMEBUFFERTEXTURE2DPROC GL_FramebufferTexture2DFunc = NULL; //rorybabory
QS_PFNGLGENRENDERBUFFERSPROC GL_GenRenderbuffersFunc = NULL; //rorybabory
QS_PFNGLBINDRENDERBUFFERPROC GL_BindRenderbufferFunc = NULL; //rorybabory
QS_PFNGLBINDRENDERBUFFERPROC GL_RenderbufferStorageFunc = NULL; //rorybabory
QS_PFNGLFRAMEBUFFERRENDERBUFFERPROC GL_FramebufferRenderbufferFunc = NULL; //rorybabory
QS_PFNGLGENVERTEXARRAYSPROC GL_GenVertexArraysFunc = NULL; //rorybabory
QS_PFNGLBINDVERTEXARRAYPROC GL_BindVertexArrayFunc = NULL; //rorybabory
QS_PFNGLCHECKFRAMEBUFFERSTATUSPROC GL_CheckFramebufferStatus = NULL; //rorybabory
QS_PFNGLFRAMEBUFFERTEXTUREPROC GL_FramebufferTextureFunc = NULL; //rorybabory
QS_PFNGLACTIVETEXTUREPROC GL_ActiveTextureFunc = NULL; //rorybabory
//====================================
...
static void GL_CheckExtensions (void)
{
	...
	else if (gl_version_major >= 2)
	{
		...
		GL_GenVertexArraysFunc = (QS_PFNGLGENVERTEXARRAYSPROC)SDL_GL_GetProcAddress("glGenVertexArrays");
		GL_BindVertexArrayFunc = (QS_PFNGLBINDVERTEXARRAYPROC)SDL_GL_GetProcAddress("glBindVertexArray");
		GL_CheckFramebufferStatus = (QS_PFNGLCHECKFRAMEBUFFERSTATUSPROC)SDL_GL_GetProcAddress("glCheckFramebufferStatus");
		GL_FramebufferTextureFunc = (QS_PFNGLFRAMEBUFFERTEXTUREPROC)SDL_GL_GetProcAddress("glFramebufferTexture");
		GL_ActiveTextureFunc = (QS_PFNGLACTIVETEXTUREPROC)SDL_GL_GetProcAddress("glActiveTexture");
