...
void R_DrawTextureChainsLighting(qmodel_t* model, entity_t* ent, texchain_t chain)
{
	float entalpha;
...
=============
*/
void R_DrawWorldLighting(void)
{
	if (!r_drawworld_cheatsafe)
		return;

	R_DrawTextureChainsLighting(cl.worldmodel, NULL, chain_world);
}
