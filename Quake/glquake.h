...
typedef void (APIENTRYP QS_PFNGLGENFRAMEBUFFERSPROC) (GLsizei n, GLuint* ids);
...
typedef void (APIENTRYP QS_PFNGLFRAMEBUFFERTEXTUREPROC) (GLenum target, GLenum attachment, GLuint texture, GLint level);
typedef void (APIENTRYP QS_PFNGLACTIVETEXTUREPROC) (GLenum texture);
...
extern QS_PFNGLCHECKFRAMEBUFFERSTATUSPROC GL_CheckFramebufferStatus;
extern QS_PFNGLFRAMEBUFFERTEXTUREPROC GL_FramebufferTextureFunc;
extern QS_PFNGLACTIVETEXTUREPROC GL_ActiveTextureFunc;
